...
export interface BrandCaseStudy {
  ...
  categories: PortfolioProject['category'][];
  itemCount: number;
  isLogoCover?: boolean;
}
...
export const PORTFOLIO_PROJECTS: PortfolioProject[] = [
  ...
  },
  {
    ...
    "coverImage": "/home/salesflow/Downloads/Docs/logo/",
    "images": [
      {
...
const BRAND_ALIASES: Record<string, string> = {
  'BOCS Pizza Theater Ad': 'BOCS Pizza',
  'RK Ecran Promo Video': 'RK Ecran',
  'Dall Labs Style Guide': 'Dall Labs',
  'Invictus Brand Identity': 'Invictus',
  'Snacko Brand Guidelines': 'Snacko',
  'Zootoca Logo Design': 'Zootoca',
  'Digiobz Logo Design': 'Digiobz',
};

const BRAND_LOGO_COVERS: Record<string, string> = {
  'ARD Solutions': '/brand-logos/ARD  Solutions.png',
  'BOCS Pizza': '/brand-logos/BOCS Pizza.png',
  'Curry Life': '/brand-logos/Curry Life.png',
  'Dall Labs': '/brand-logos/Dall labs Logo.png',
  'Digiobz': '/brand-logos/digiobz logo.png',
  'E-Now Batteries': '/brand-logos/_E- Now Enables creatives - June 2025.png',
  'Invictus': '/brand-logos/Invictus logo.png',
  'Kanmani Milk': '/brand-logos/Kanmani.png',
  'Meddipro': '/brand-logos/Mediprro.png',
  'RK Ecran': '/brand-logos/17.png',
  'Pupa': '/brand-logos/Pupa.png',
  'Snacko': '/brand-logos/Snacko Logo.png',
  'Sumangali Jewellery': '/brand-logos/Sumangali.png',
  'Thenneera': '/brand-logos/26.png',
  'Vakaman Developers': '/brand-logos/29.png',
  'Techno Sports': '/brand-logos/30.png',
  'Perroquetta Roofing': '/brand-logos/perroqueta logo.png',
  'Zootoca': '/brand-logos/zootoca logo.png',
};

/** One portfolio tile per client, with every available creative discipline inside it. */
export const BRAND_CASE_STUDIES: BrandCaseStudy[] = Object.values(
  PORTFOLIO_PROJECTS.reduce<Record<string, BrandCaseStudy>>((cases, project) => {
    const brand = BRAND_ALIASES[project.brand] ?? project.brand;
    const existing = cases[brand];

    if (existing) {
      existing.projects.push(project);
      existing.categories = Array.from(new Set([...existing.categories, project.category]));
      existing.itemCount += project.itemCount;
      if (!existing.coverImage && project.coverImage) existing.coverImage = project.coverImage;
      return cases;
    }
  ...
  const logoCover = BRAND_LOGO_COVERS[caseStudy.brand];
  return logoCover ? { ...caseStudy, coverImage: logoCover, isLogoCover: true } : caseStudy;
});
